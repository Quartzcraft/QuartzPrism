...
import uk.co.quartzcraft.prism.actionlibs.ActionType;
import uk.co.quartzcraft.prism.actionlibs.QueryParameters;
import uk.co.quartzcraft.prism.appliers.ChangeResult;
...
public class GenericAction implements Handler {
    ...
    /*
     * (non-Javadoc)
     * @see Handler#setDisplayDate(java.lang.String)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see Handler#setWorldName(java.lang.String)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see Handler#setPlayerName(java.lang.String)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see Handler#setBlockSubId(byte)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see Handler#setOldBlockSubId(byte)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see Handler#setData(java.lang.String)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see Handler#setMaterialAliases(me.botsko.prism.
     * MaterialAliases)
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see Handler#setAggregateCount(int)
     */
    @Override
